...
export default function TenantProfile({ profile, onUpgrade, upgradeLoading }) {
  ...
  return (
    <motion.div
      ...
      className="bg-slate-900/40 border border-slate-800/80 p-6 rounded-2xl shadow-2xl relative overflow-hidden backdrop-blur-xl"
    >
      ...
      <div className="space-y-4">
        ...
        <div className="bg-slate-950/80 border border-slate-800/60 rounded-xl p-3 mt-4 shadow-inner">
      ...
      <motion.button
        ...
        onClick={onUpgrade}
        className="w-full mt-6 py-3 px-4 rounded-xl font-bold text-xs tracking-wider uppercase bg-slate-950/40 border border-slate-800 hover:border-purple-500/40 text-slate-300 flex items-center justify-center gap-2 shadow-lg transition-all"
      >
        {upgradeLoading ? (
